...
namespace DevOpsIngestion.Core.Ingestion;
    ...
    VectorStoreCollection<Guid, IngestedDocument> documentsCollection)
{
    ...
    public async Task IngestDataAsync(IIngestionSource source)
    {
        ...
        var documentsForSource = await AsyncEnumerable.ToListAsync(
            documentsCollection.GetAsync(doc => doc.SourceId == sourceId, top: int.MaxValue)
        );
