...
Configure your Azure OpenAI API key and endpoint for this project, using .NET User Secrets:
   ...
   3. In Visual Studio, right-click on the DevOpsIngestion.Chat.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the DevOpsIngestion.Chat.AppHost project.
...
This template leverages JavaScript libraries to provide essential functionality. These libraries are located in the wwwroot/lib folder of the DevOpsIngestion.Chat.Web project. For instructions on updating each dependency, please refer to the README.md file in each respective folder.
